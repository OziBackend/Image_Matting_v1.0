...
def image_matting(app, file_path, file, return_data):
    with app.app_context():
        try:
            ...
            if rgba_foreground_image is not None:
            ...
            print(f"2... : In Image_Matting function, the exception is = {e}")
            return_data['image_url'] =  ""
...
def generate_rgba_foreground(app, image, matte, image_name):
    with app.app_context():
        try:
            ...
            print(f"1... : In Generate_RGBA_Foreground function, the exception is = {e}")
            return None
